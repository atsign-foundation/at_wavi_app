...
1. Fork in GitHub https://github.com/atsign-foundation/at_wavi_app
2. Clone *your forked repository* (e.g., `git clone git@github.com:yourname/at_wavi_app`)
3. Set your remotes as follows:

   ```sh
   cd at_wavi_app
   git remote add upstream git@github.com:atsign-foundation/at_wavi_app.git
   ...
   ```text
   origin  git@github.com:yourname/at_wavi_app.git (fetch)
   origin  git@github.com:yourname/at_wavi_app.git (push)
   upstream        git@github.com:atsign-foundation/at_wavi_app.git (fetch)
