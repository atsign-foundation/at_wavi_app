...
class DesktopLoginGuidePage extends StatefulWidget {
  const DesktopLoginGuidePage({Key? key}) : super(key: key);

  @override
  _DesktopLoginGuidePageState createState() => _DesktopLoginGuidePageState();
}

class _DesktopLoginGuidePageState extends State<DesktopLoginGuidePage> {
