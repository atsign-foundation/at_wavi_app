...
class DesktopEditAdditionalDetailPage extends StatefulWidget {
  const DesktopEditAdditionalDetailPage({Key? key}) : super(key: key);

  @override
  _DesktopEditAdditionalDetailState createState() => _DesktopEditAdditionalDetailState();
}

class _DesktopEditAdditionalDetailState extends State<DesktopEditAdditionalDetailPage> {
  final _showHideController = ShowHideController(isShow: true);
  late DesktopEditAdditionalDetailModel _model;
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (BuildContext c) {
        ...
        _model = DesktopEditAdditionalDetailModel(userPreview: userPreview);
        return _model;
      },
      child: Container(
        width: 434,
  ...
  Widget _buildContentWidget() {
    return Consumer<DesktopEditAdditionalDetailModel>(
